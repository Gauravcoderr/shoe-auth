...
export default function BrandGuidePage({ params }: Props) {
  ...
  if (!guide) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-20 text-center">
        ...
        <Link href="/guides" className="text-gray-900 font-medium hover:underline">← All guides</Link>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      <Link href="/guides" className="text-sm text-gray-400 hover:text-gray-700 mb-6 inline-block">
        ← All guides
      </Link>
      <h1 className="text-3xl font-bold text-gray-900 mb-3">How to spot fake {guide.name} sneakers</h1>
      <p className="text-gray-500 mb-10">{guide.intro}</p>
      ...
      <div className="mt-10 p-5 bg-gray-900 text-white rounded-2xl text-center">
        <h3 className="font-bold mb-2">Want AI to check these for you?</h3>
        <p className="text-gray-400 text-sm mb-4">Upload your shoe photos and our AI checks all these points automatically.</p>
        <Link
          href={`/check?brand=${params.brand}`}
          className="inline-block bg-white text-gray-900 px-6 py-2.5 rounded-xl text-sm font-semibold hover:bg-gray-100 transition-colors"
        >
